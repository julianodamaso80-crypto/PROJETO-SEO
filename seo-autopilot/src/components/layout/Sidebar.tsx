            ...
            return (
              <Link
                ...
                style={{
                  ...
                  fontSize: "14px",
                  fontWeight: 500,
                  color: isActive ? "#fff" : "var(--text-on-dark-secondary)",
                  background: isActive ? "rgba(255,255,255,0.12)" : "transparent",
                  borderLeft: isActive ? "2px solid var(--bg-sand)" : "2px solid transparent",
                  textDecoration: "none",
          ...
          >
            <div
              style={{
                ...
                height: "32px",
                borderRadius: "50%",
                background: "rgba(211,199,173,0.2)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                color: "var(--bg-sand)",
