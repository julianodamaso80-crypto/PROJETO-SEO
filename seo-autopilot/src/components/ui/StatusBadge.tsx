...
const statusStyles: Record<string, { bg: string; color: string; label: string }> = {
  ...
  approved: { bg: "rgba(0,255,136,0.2)", color: "#00ff88", label: "Aprovado" },
  published: { bg: "rgba(0,255,136,0.2)", color: "#00ff88", label: "Publicado" },
  publishing: { bg: "rgba(96,165,250,0.2)", color: "#60a5fa", label: "Publicando" },
  failed: { bg: "rgba(239,68,68,0.2)", color: "#f87171", label: "Falha" },
  completed: { bg: "rgba(0,255,136,0.2)", color: "#00ff88", label: "Completo" },
